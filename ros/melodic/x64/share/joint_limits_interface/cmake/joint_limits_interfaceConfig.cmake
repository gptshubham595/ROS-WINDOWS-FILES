...
if("FALSE" STREQUAL "TRUE")
  set(joint_limits_interface_SOURCE_PREFIX D:/catkin_ws/src/ros_control/joint_limits_interface)
  set(joint_limits_interface_DEVEL_PREFIX D:/catkin_ws/devel_isolated/joint_limits_interface)
  ...
  set(joint_limits_interface_INSTALL_PREFIX D:/opt/ros/melodic/x64)
...
if(NOT "include;D:/opt/rosdeps/x64/include " STREQUAL " ")
  set(joint_limits_interface_INCLUDE_DIRS "")
  set(_include_dirs "include;D:/opt/rosdeps/x64/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'joint_limits_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'D:/opt/ros/melodic/x64/${idir}'.  ${_report}")
    endif()
    _list_append_unique(joint_limits_interface_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "D:/opt/rosdeps/x64/lib/urdfdom_sensor.lib;D:/opt/rosdeps/x64/lib/urdfdom_model_state.lib;D:/opt/rosdeps/x64/lib/urdfdom_model.lib;D:/opt/rosdeps/x64/lib/urdfdom_world.lib;D:/opt/rosdeps/x64/lib/console_bridge.lib")
