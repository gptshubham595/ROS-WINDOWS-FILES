...
if("FALSE" STREQUAL "TRUE")
  ...
  set(joint_limits_interface_INSTALL_PREFIX C:/opt/ros/melodic/x64)
...
if(NOT "include;C:/opt/rosdeps/x64/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'joint_limits_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/opt/ros/melodic/x64/${idir}'.  ${_report}")
    endif()
    _list_append_unique(joint_limits_interface_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "C:/opt/rosdeps/x64/lib/urdfdom_sensor.lib;C:/opt/rosdeps/x64/lib/urdfdom_model_state.lib;C:/opt/rosdeps/x64/lib/urdfdom_model.lib;C:/opt/rosdeps/x64/lib/urdfdom_world.lib;C:/opt/rosdeps/x64/lib/console_bridge.lib")
