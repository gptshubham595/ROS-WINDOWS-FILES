...
if("FALSE" STREQUAL "TRUE")
  set(depth_image_proc_SOURCE_PREFIX D:/a/1/a/_ws/src/image_pipeline/depth_image_proc)
  set(depth_image_proc_DEVEL_PREFIX D:/a/1/a/_output/devel_isolated/depth_image_proc)
  ...
  set(depth_image_proc_INSTALL_PREFIX C:/opt/ros/melodic/x64)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'depth_image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/opt/ros/melodic/x64/${idir}'.  ${_report}")
    endif()
