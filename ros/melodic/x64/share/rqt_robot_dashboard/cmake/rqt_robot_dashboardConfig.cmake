...
if("FALSE" STREQUAL "TRUE")
  set(rqt_robot_dashboard_SOURCE_PREFIX D:/a/1/a/_ws/src/rqt_robot_dashboard)
  set(rqt_robot_dashboard_DEVEL_PREFIX D:/a/1/a/_output/devel_isolated/rqt_robot_dashboard)
  ...
  set(rqt_robot_dashboard_INSTALL_PREFIX C:/opt/ros/melodic/x64)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rqt_robot_dashboard' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/opt/ros/melodic/x64/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND rqt_robot_dashboard_EXPORTED_TARGETS ${${rqt_robot_dashboard_dep}_EXPORTED_TARGETS})
endforeach()
