...
if("FALSE" STREQUAL "TRUE")
  set(rosgraph_SOURCE_PREFIX D:/a/1/a/_ws/src/ros_comm/tools/rosgraph)
  set(rosgraph_DEVEL_PREFIX D:/a/1/a/_output/devel_isolated/rosgraph)
  set(rosgraph_INSTALL_PREFIX "")
  set(rosgraph_PREFIX ${rosgraph_DEVEL_PREFIX})
else()
  set(rosgraph_SOURCE_PREFIX "")
  set(rosgraph_DEVEL_PREFIX "")
  set(rosgraph_INSTALL_PREFIX C:/opt/ros/melodic/x64)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosgraph' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/opt/ros/melodic/x64/${idir}'.  ${_report}")
    endif()
