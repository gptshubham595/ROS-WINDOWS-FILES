...
if("FALSE" STREQUAL "TRUE")
  set(robotiq_modbus_rtu_SOURCE_PREFIX D:/catkin_ws/src/robotiq/robotiq_modbus_rtu)
  set(robotiq_modbus_rtu_DEVEL_PREFIX D:/catkin_ws/devel_isolated/robotiq_modbus_rtu)
  ...
  set(robotiq_modbus_rtu_INSTALL_PREFIX D:/opt/ros/melodic/x64)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robotiq_modbus_rtu' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'D:/opt/ros/melodic/x64/${idir}'.  ${_report}")
    endif()
