...
if("FALSE" STREQUAL "TRUE")
  ...
  set(rosconsole_INSTALL_PREFIX C:/opt/ros/melodic/x64)
...
if(NOT "include;C:/opt/rosdeps/x64/include/boost-1_66 " STREQUAL " ")
  set(rosconsole_INCLUDE_DIRS "")
  set(_include_dirs "include;C:/opt/rosdeps/x64/include/boost-1_66")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosconsole' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/opt/ros/melodic/x64/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rosconsole_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rosconsole;rosconsole_log4cxx;rosconsole_backend_interface;C:/opt/rosdeps/x64/lib/log4cxx.lib;optimized;C:/opt/rosdeps/x64/lib/boost_regex-vc141-mt-x64-1_66.lib;debug;C:/opt/rosdeps/x64/lib/boost_regex-vc141-mt-gd-x64-1_66.lib;optimized;C:/opt/rosdeps/x64/lib/boost_system-vc141-mt-x64-1_66.lib;debug;C:/opt/rosdeps/x64/lib/boost_system-vc141-mt-gd-x64-1_66.lib;optimized;C:/opt/rosdeps/x64/lib/boost_thread-vc141-mt-x64-1_66.lib;debug;C:/opt/rosdeps/x64/lib/boost_thread-vc141-mt-gd-x64-1_66.lib;optimized;C:/opt/rosdeps/x64/lib/boost_chrono-vc141-mt-x64-1_66.lib;debug;C:/opt/rosdeps/x64/lib/boost_chrono-vc141-mt-gd-x64-1_66.lib;optimized;C:/opt/rosdeps/x64/lib/boost_date_time-vc141-mt-x64-1_66.lib;debug;C:/opt/rosdeps/x64/lib/boost_date_time-vc141-mt-gd-x64-1_66.lib;optimized;C:/opt/rosdeps/x64/lib/boost_atomic-vc141-mt-x64-1_66.lib;debug;C:/opt/rosdeps/x64/lib/boost_atomic-vc141-mt-gd-x64-1_66.lib")
