...
if("FALSE" STREQUAL "TRUE")
  ...
  set(urdf_INSTALL_PREFIX C:/opt/ros/melodic/x64)
...
if(NOT "include;C:/opt/rosdeps/x64/include;C:/opt/rosdeps/x64/include/boost-1_66 " STREQUAL " ")
  set(urdf_INCLUDE_DIRS "")
  set(_include_dirs "include;C:/opt/rosdeps/x64/include;C:/opt/rosdeps/x64/include/boost-1_66")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/opt/ros/melodic/x64/${idir}'.  ${_report}")
    endif()
    _list_append_unique(urdf_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "urdf;C:/opt/rosdeps/x64/lib/urdfdom_sensor.lib;C:/opt/rosdeps/x64/lib/urdfdom_model_state.lib;C:/opt/rosdeps/x64/lib/urdfdom_model.lib;C:/opt/rosdeps/x64/lib/urdfdom_world.lib;C:/opt/rosdeps/x64/lib/console_bridge.lib;optimized;C:/opt/rosdeps/x64/lib/boost_thread-vc141-mt-x64-1_66.lib;debug;C:/opt/rosdeps/x64/lib/boost_thread-vc141-mt-gd-x64-1_66.lib;optimized;C:/opt/rosdeps/x64/lib/boost_chrono-vc141-mt-x64-1_66.lib;debug;C:/opt/rosdeps/x64/lib/boost_chrono-vc141-mt-gd-x64-1_66.lib;optimized;C:/opt/rosdeps/x64/lib/boost_system-vc141-mt-x64-1_66.lib;debug;C:/opt/rosdeps/x64/lib/boost_system-vc141-mt-gd-x64-1_66.lib;optimized;C:/opt/rosdeps/x64/lib/boost_date_time-vc141-mt-x64-1_66.lib;debug;C:/opt/rosdeps/x64/lib/boost_date_time-vc141-mt-gd-x64-1_66.lib;optimized;C:/opt/rosdeps/x64/lib/boost_atomic-vc141-mt-x64-1_66.lib;debug;C:/opt/rosdeps/x64/lib/boost_atomic-vc141-mt-gd-x64-1_66.lib;C:/opt/rosdeps/x64/lib/tinyxml.lib;C:/opt/rosdeps/x64/lib/tinyxml2.lib")
