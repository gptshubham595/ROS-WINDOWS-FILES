...
if("FALSE" STREQUAL "TRUE")
  set(urdf_SOURCE_PREFIX D:/catkin_ws/src/urdf/urdf)
  set(urdf_DEVEL_PREFIX D:/catkin_ws/devel_isolated/urdf)
  set(urdf_INSTALL_PREFIX "")
  set(urdf_PREFIX ${urdf_DEVEL_PREFIX})
else()
  set(urdf_SOURCE_PREFIX "")
  set(urdf_DEVEL_PREFIX "")
  set(urdf_INSTALL_PREFIX D:/opt/ros/melodic/x64)
...
if(NOT "include;D:/opt/rosdeps/x64/include;D:/opt/rosdeps/x64/include/boost-1_66 " STREQUAL " ")
  set(urdf_INCLUDE_DIRS "")
  set(_include_dirs "include;D:/opt/rosdeps/x64/include;D:/opt/rosdeps/x64/include/boost-1_66")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'D:/opt/ros/melodic/x64/${idir}'.  ${_report}")
    endif()
    _list_append_unique(urdf_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "urdf;D:/opt/rosdeps/x64/lib/urdfdom_sensor.lib;D:/opt/rosdeps/x64/lib/urdfdom_model_state.lib;D:/opt/rosdeps/x64/lib/urdfdom_model.lib;D:/opt/rosdeps/x64/lib/urdfdom_world.lib;D:/opt/rosdeps/x64/lib/console_bridge.lib;optimized;D:/opt/rosdeps/x64/lib/boost_thread-vc141-mt-x64-1_66.lib;debug;D:/opt/rosdeps/x64/lib/boost_thread-vc141-mt-gd-x64-1_66.lib;optimized;D:/opt/rosdeps/x64/lib/boost_chrono-vc141-mt-x64-1_66.lib;debug;D:/opt/rosdeps/x64/lib/boost_chrono-vc141-mt-gd-x64-1_66.lib;optimized;D:/opt/rosdeps/x64/lib/boost_system-vc141-mt-x64-1_66.lib;debug;D:/opt/rosdeps/x64/lib/boost_system-vc141-mt-gd-x64-1_66.lib;optimized;D:/opt/rosdeps/x64/lib/boost_date_time-vc141-mt-x64-1_66.lib;debug;D:/opt/rosdeps/x64/lib/boost_date_time-vc141-mt-gd-x64-1_66.lib;optimized;D:/opt/rosdeps/x64/lib/boost_atomic-vc141-mt-x64-1_66.lib;debug;D:/opt/rosdeps/x64/lib/boost_atomic-vc141-mt-gd-x64-1_66.lib;D:/opt/rosdeps/x64/lib/tinyxml.lib;D:/opt/rosdeps/x64/lib/tinyxml2.lib")
