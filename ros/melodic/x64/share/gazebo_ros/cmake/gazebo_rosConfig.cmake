...
if("FALSE" STREQUAL "TRUE")
  set(gazebo_ros_SOURCE_PREFIX D:/catkin_ws/src/gazebo_ros_pkgs/gazebo_ros)
  set(gazebo_ros_DEVEL_PREFIX D:/catkin_ws/devel_isolated/gazebo_ros)
  ...
  set(gazebo_ros_INSTALL_PREFIX D:/opt/ros/melodic/x64)
...
if(NOT "include;D:/opt/rosdeps/x64/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'D:/opt/ros/melodic/x64/${idir}'.  ${_report}")
    endif()
    _list_append_unique(gazebo_ros_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "gazebo_ros_api_plugin;gazebo_ros_paths_plugin;D:/opt/rosdeps/x64/lib/tinyxml.lib")
