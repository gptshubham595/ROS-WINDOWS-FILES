...
if("FALSE" STREQUAL "TRUE")
  set(camera_calibration_parsers_SOURCE_PREFIX D:/catkin_ws/src/image_common/camera_calibration_parsers)
  set(camera_calibration_parsers_DEVEL_PREFIX D:/catkin_ws/devel_isolated/camera_calibration_parsers)
  ...
  set(camera_calibration_parsers_INSTALL_PREFIX D:/opt/ros/melodic/x64)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'camera_calibration_parsers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'D:/opt/ros/melodic/x64/${idir}'.  ${_report}")
    endif()
