...
if("FALSE" STREQUAL "TRUE")
  set(rostest_SOURCE_PREFIX D:/catkin_ws/src/ros_comm/tools/rostest)
  set(rostest_DEVEL_PREFIX D:/catkin_ws/devel_isolated/rostest)
  set(rostest_INSTALL_PREFIX "")
  set(rostest_PREFIX ${rostest_DEVEL_PREFIX})
else()
  set(rostest_SOURCE_PREFIX "")
  set(rostest_DEVEL_PREFIX "")
  set(rostest_INSTALL_PREFIX D:/opt/ros/melodic/x64)
...
if(NOT "include;D:/opt/rosdeps/x64/include/boost-1_66 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rostest' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'D:/opt/ros/melodic/x64/${idir}'.  ${_report}")
    endif()
