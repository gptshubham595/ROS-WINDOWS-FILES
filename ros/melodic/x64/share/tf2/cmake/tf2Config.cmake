...
if("FALSE" STREQUAL "TRUE")
  ...
  set(tf2_INSTALL_PREFIX C:/opt/ros/melodic/x64)
...
if(NOT "include;C:/opt/rosdeps/x64/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/opt/ros/melodic/x64/${idir}'.  ${_report}")
    endif()
    _list_append_unique(tf2_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "tf2;C:/opt/rosdeps/x64/lib/console_bridge.lib")
