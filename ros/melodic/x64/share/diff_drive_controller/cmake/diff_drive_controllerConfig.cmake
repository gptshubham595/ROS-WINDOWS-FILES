...
if("FALSE" STREQUAL "TRUE")
  set(diff_drive_controller_SOURCE_PREFIX D:/a/1/a/_ws/src/ros_controllers/diff_drive_controller)
  set(diff_drive_controller_DEVEL_PREFIX D:/a/1/a/_output/devel_isolated/diff_drive_controller)
  ...
  set(diff_drive_controller_INSTALL_PREFIX C:/opt/ros/melodic/x64)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'diff_drive_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/opt/ros/melodic/x64/${idir}'.  ${_report}")
    endif()
