...
if("FALSE" STREQUAL "TRUE")
  set(rosconsole_bridge_SOURCE_PREFIX D:/catkin_ws/src/rosconsole_bridge)
  set(rosconsole_bridge_DEVEL_PREFIX D:/catkin_ws/devel_isolated/rosconsole_bridge)
  ...
  set(rosconsole_bridge_INSTALL_PREFIX D:/opt/ros/melodic/x64)
...
if(NOT "include;D:/opt/rosdeps/x64/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosconsole_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'D:/opt/ros/melodic/x64/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rosconsole_bridge_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rosconsole_bridge;D:/opt/rosdeps/x64/lib/console_bridge.lib")
