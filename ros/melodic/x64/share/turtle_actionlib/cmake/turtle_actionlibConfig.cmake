...
if("FALSE" STREQUAL "TRUE")
  set(turtle_actionlib_SOURCE_PREFIX D:/catkin_ws/src/common_tutorials/turtle_actionlib)
  set(turtle_actionlib_DEVEL_PREFIX D:/catkin_ws/devel_isolated/turtle_actionlib)
  ...
  set(turtle_actionlib_INSTALL_PREFIX D:/opt/ros/melodic/x64)
...
if(NOT "include " STREQUAL " ")
  ...
  elseif(NOT "http://ros.org/wiki/turtle_actionlib " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/turtle_actionlib' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'turtle_actionlib' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'turtle_actionlib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'D:/opt/ros/melodic/x64/${idir}'.  ${_report}")
    endif()
...
set(turtle_actionlib_EXPORTED_TARGETS "turtle_actionlib_generate_messages_cpp;turtle_actionlib_generate_messages_eus;turtle_actionlib_generate_messages_lisp;turtle_actionlib_generate_messages_nodejs;turtle_actionlib_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${turtle_actionlib_dep}_FOUND)
      find_package(${turtle_actionlib_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${turtle_actionlib_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
