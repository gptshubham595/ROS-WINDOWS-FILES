...
if("FALSE" STREQUAL "TRUE")
  set(velocity_controllers_SOURCE_PREFIX D:/catkin_ws/src/ros_controllers/velocity_controllers)
  set(velocity_controllers_DEVEL_PREFIX D:/catkin_ws/devel_isolated/velocity_controllers)
  ...
  set(velocity_controllers_INSTALL_PREFIX D:/opt/ros/melodic/x64)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velocity_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'D:/opt/ros/melodic/x64/${idir}'.  ${_report}")
    endif()
