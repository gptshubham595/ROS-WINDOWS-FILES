...
if("FALSE" STREQUAL "TRUE")
  set(imu_sensor_controller_SOURCE_PREFIX D:/catkin_ws/src/ros_controllers/imu_sensor_controller)
  set(imu_sensor_controller_DEVEL_PREFIX D:/catkin_ws/devel_isolated/imu_sensor_controller)
  ...
  set(imu_sensor_controller_INSTALL_PREFIX D:/opt/ros/melodic/x64)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'imu_sensor_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'D:/opt/ros/melodic/x64/${idir}'.  ${_report}")
    endif()
