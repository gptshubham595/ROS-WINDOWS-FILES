...
if("FALSE" STREQUAL "TRUE")
  set(image_proc_SOURCE_PREFIX D:/catkin_ws/src/image_pipeline/image_proc)
  set(image_proc_DEVEL_PREFIX D:/catkin_ws/devel_isolated/image_proc)
  ...
  set(image_proc_INSTALL_PREFIX D:/opt/ros/melodic/x64)
...
if(NOT "include;D:/opt/rosdeps/x64/include;D:/opt/rosdeps/x64/include/opencv " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'D:/opt/ros/melodic/x64/${idir}'.  ${_report}")
    endif()
    _list_append_unique(image_proc_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "image_proc;D:/opt/rosdeps/x64/lib/opencv_calib3d341.lib;D:/opt/rosdeps/x64/lib/opencv_core341.lib;D:/opt/rosdeps/x64/lib/opencv_dnn341.lib;D:/opt/rosdeps/x64/lib/opencv_features2d341.lib;D:/opt/rosdeps/x64/lib/opencv_flann341.lib;D:/opt/rosdeps/x64/lib/opencv_highgui341.lib;D:/opt/rosdeps/x64/lib/opencv_imgcodecs341.lib;D:/opt/rosdeps/x64/lib/opencv_imgproc341.lib;D:/opt/rosdeps/x64/lib/opencv_ml341.lib;D:/opt/rosdeps/x64/lib/opencv_objdetect341.lib;D:/opt/rosdeps/x64/lib/opencv_photo341.lib;D:/opt/rosdeps/x64/lib/opencv_shape341.lib;D:/opt/rosdeps/x64/lib/opencv_stitching341.lib;D:/opt/rosdeps/x64/lib/opencv_superres341.lib;D:/opt/rosdeps/x64/lib/opencv_video341.lib;D:/opt/rosdeps/x64/lib/opencv_videoio341.lib;D:/opt/rosdeps/x64/lib/opencv_videostab341.lib")
