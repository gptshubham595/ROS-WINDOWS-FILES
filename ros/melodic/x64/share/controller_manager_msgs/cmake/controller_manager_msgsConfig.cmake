...
if("FALSE" STREQUAL "TRUE")
  set(controller_manager_msgs_SOURCE_PREFIX D:/catkin_ws/src/ros_control/controller_manager_msgs)
  set(controller_manager_msgs_DEVEL_PREFIX D:/catkin_ws/devel_isolated/controller_manager_msgs)
  ...
  set(controller_manager_msgs_INSTALL_PREFIX D:/opt/ros/melodic/x64)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'D:/opt/ros/melodic/x64/${idir}'.  ${_report}")
    endif()
