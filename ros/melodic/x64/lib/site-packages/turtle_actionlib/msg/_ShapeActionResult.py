...
"""autogenerated by genpy from turtle_actionlib/ShapeActionResult.msg. Do not edit."""
import sys
...
class ShapeActionResult(genpy.Message):
  _md5sum = "c8d13d5d140f1047a2e4d3bf5c045822"
  _type = "turtle_actionlib/ShapeActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','turtle_actionlib/ShapeResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ShapeActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = turtle_actionlib.msg.ShapeResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = turtle_actionlib.msg.ShapeResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_2f().pack(_x.result.interior_angle, _x.result.apothem))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.interior_angle, _x.result.apothem,) = _get_struct_2f().unpack(str[start:end])
      return self
