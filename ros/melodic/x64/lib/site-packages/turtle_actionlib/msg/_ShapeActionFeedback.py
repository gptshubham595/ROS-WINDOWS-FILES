...
"""autogenerated by genpy from turtle_actionlib/ShapeActionFeedback.msg. Do not edit."""
import sys
...
class ShapeActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "turtle_actionlib/ShapeActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','turtle_actionlib/ShapeFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ShapeActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = turtle_actionlib.msg.ShapeFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = turtle_actionlib.msg.ShapeFeedback()
